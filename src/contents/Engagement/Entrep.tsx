...
import { Businness, Conclusion, Financials, LongTermImpacts, MarkerAnalysis, ProblemStatement, Regulatory, Solutions, UnmetNeeds } from './EntrepSection';
...
export function BusinessModelCanvas() {
  return  (
    <ContentPage>
        <SectionsTemplate title={`Unmet needs`} left="10%" mt="4em" mb="2" align="center">
          <UnmetNeeds />
        </SectionsTemplate>
        
        <SectionsTemplate title={`Problem Statement`} left="10%" mt="0" mb="2">
          <ProblemStatement />
        </SectionsTemplate>

        <SectionsTemplate title={`Market Analysis`} left="10%" mt="0" mb="2">
          <MarkerAnalysis />
        </SectionsTemplate>
        
        <SectionsTemplate title={`Our Solution`} left="10%" mt="0" mb="2">
          <Solutions />
        </SectionsTemplate>
        
        <SectionsTemplate title={`Business Model`} left="10%" mt="0" mb="2">
          <Businness />
        </SectionsTemplate>

        <SectionsTemplate title={`Regulatory & IP Strategy`} left="10%" mt="0" mb="2">
          <Regulatory />
        </SectionsTemplate>

        <SectionsTemplate title={`Financials`} left="10%" mt="0" mb="2">
          <Financials />
        </SectionsTemplate>

        <SectionsTemplate title={`Long Term Impacts`} left="10%" mt="0" mb="2">
          <LongTermImpacts />
        </SectionsTemplate>

        <SectionsTemplate title={`Conclusion`} left="10%" mt="0" mb="2">
          <Conclusion />
        </SectionsTemplate>
